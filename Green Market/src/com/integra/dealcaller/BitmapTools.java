...
import com.integra.dealcaller.BitmapCache;
import com.integra.dealcaller.BitmapDecoder;
import com.integra.dealcaller.ClearCacheRequest;
import com.integra.dealcaller.IDisplayer;
import com.integra.dealcaller.ImageLoader;
import com.integra.dealcaller.NetworkImageView;
import com.integra.dealcaller.R;
import com.integra.dealcaller.RequestQueue;
import com.integra.dealcaller.SimpleDisplayer;
import com.integra.dealcaller.Volley;
import com.integra.dealcaller.VolleyError;
import com.integra.dealcaller.BitmapTools.BitmapDisplayConfig.RoundConfig;
    ...
    private ImageContainer doDisplay(final View view, final String uri, BitmapDisplayConfig displayConfig, ImageListener listener, LoadingListener loadingListener) {
      if (displayConfig == null) {
        ...
        if (view instanceof NetworkImageView) {
            ...
            WeakReference<ImageContainer> ref = (WeakReference<ImageContainer>) view.getTag(R.id.listok);
             if (ref != null) {
            ...
            if (TextUtils.isEmpty(uri)) {
                if (tagContainer != null) {
                    ...
                    tagContainer = null;
                    view.setTag(R.id.listok, tagContainer);
                }
...
//                    mDisplayer.setDefaultImageOrNull(view, curDisplayConfig.defaultImageResId);
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR1 && view.getTag(R.id.listok) == null) {
          ...
          @SuppressWarnings("deprecation")
            ...
            view.setTag(R.id.listok, new WeakReference<ImageContainer>(container));
            return container;
        }
    }
