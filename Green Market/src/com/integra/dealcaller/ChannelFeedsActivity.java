...
import com.integra.dealcaller.TimeLineFragment22.GetDataTask;
...
public class ChannelFeedsActivity extends ActionBarActivity implements OnClickListener,OnTouchListener{
	
	
	 
    // Movies json url
	private static final String TAG = ChannelFeedsActivity.class.getSimpleName();
    public static PullToRefreshListView listView;
    public static FeedListAdapter22 listAdapter;
    private JsonObjectRequest jsonReq,jsonReqqy;
    ImageLoader imageLoader = AppController.getInstance().getImageLoader();
    private static List<FeedItem22> feedItems;
 ...
 // action bar
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        	 ...
        	 setContentView(R.layout.channels_fragment);
        
        cd = new ConnectionDetector(this);
       
    
     animSlideUp = AnimationUtils.loadAnimation(this,R.anim.fade_in);
     animSlideDown = AnimationUtils.loadAnimation(this,R.anim.fade_out);
        ...
        feedItems = new ArrayList<FeedItem22>();
        
        
        listAdapter = new FeedListAdapter22(this, feedItems);
    ...
    private static void parseJsonFeed(JSONObject response) {
        try {
            ...
            for (int i = 0; i < feedArray.length(); i++) {
                ...
                FeedItem22 item = new FeedItem22();
    ...
    public void onClick(View w) {
		...
		int id = w.getId();
		if (id == R.id.buttoso) {
			Intent iv = new Intent(this, SharePhoto.class);
			startActivity(iv);
		} else if (id == R.id.buttoso2) {
			//Intent vv = new Intent(this.getActivity(), ShareVideo.class);
			//startActivity(vv);
			Toast.makeText(this, "not fully coded yet", Toast.LENGTH_LONG).show();
		} else if (id == R.id.buttoso3) {
			//Intent vv2 = new Intent(this, EmoActivity.class);   //Originally should be UpdateStatus.class
			//startActivity(vv2);
		
			
		} else if (id == R.id.buttoso5) {
			
			Intent i = new Intent(this, ChatHeadService.class);   //Originally should be UpdateStatus.class
