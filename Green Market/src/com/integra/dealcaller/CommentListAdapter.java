...
public class CommentListAdapter extends BaseAdapter implements OnClickListener, OnTouchListener {	
	...
	public CommentListAdapter(Activity activity, List<CommentItem> movieList2) {
		this.activity = activity;
		this.feedItems = movieList2;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.profilePic = (NetworkImageView) convertView.findViewById(R.id.profilePic4noti);
