...
public class CustomListAdapter10b extends BaseAdapter implements OnClickListener, OnTouchListener{
	private Activity activity;
	private LayoutInflater inflater;
	private List<Movie10b> movieItems;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = CustomListAdapter10b.class.getSimpleName();
	...
	public CustomListAdapter10b(Activity activity, List<Movie10b> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.list_row10b, null);
		...
		final Movie10b m = movieItems.get(position);
