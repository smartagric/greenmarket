...
public class CustomListAdapter10c extends BaseAdapter implements OnClickListener, OnTouchListener{
	private Activity activity;
	private LayoutInflater inflater;
	private List<Movie10c> movieItems;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = CustomListAdapter10c.class.getSimpleName();
	...
	public CustomListAdapter10c(Activity activity, List<Movie10c> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.list_row10c, null);
		...
		final Movie10c m = movieItems.get(position);
