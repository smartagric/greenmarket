...
public class CustomListAdapter10d extends BaseAdapter implements OnClickListener, OnTouchListener{
	private Activity activity;
	private LayoutInflater inflater;
	private List<Movie10d> movieItems;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = CustomListAdapter10d.class.getSimpleName();
	...
	public CustomListAdapter10d(Activity activity, List<Movie10d> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.list_row10d, null);
		...
		final Movie10d m = movieItems.get(position);
