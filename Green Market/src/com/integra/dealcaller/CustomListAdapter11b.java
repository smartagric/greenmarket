...
public class CustomListAdapter11b extends BaseAdapter implements OnClickListener, OnTouchListener{
	private Activity activity;
	private LayoutInflater inflater;
	private List<Movie11b> movieItems;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = CustomListAdapter11b.class.getSimpleName();
	...
	public CustomListAdapter11b(Activity activity, List<Movie11b> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.list_row11b, null);
		...
		final Movie11b m = movieItems.get(position);
