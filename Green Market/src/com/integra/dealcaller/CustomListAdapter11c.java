...
public class CustomListAdapter11c extends BaseAdapter implements OnClickListener, OnTouchListener{
	private Activity activity;
	private LayoutInflater inflater;
	private List<Movie11c> movieItems;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = CustomListAdapter11c.class.getSimpleName();
	...
	public CustomListAdapter11c(Activity activity, List<Movie11c> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.list_row11c, null);
		...
		final Movie11c m = movieItems.get(position);
