...
public class CustomListAdapter12 extends BaseAdapter implements OnClickListener {
	private Activity activity;
	private LayoutInflater inflater;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = CustomListAdapter12.class.getSimpleName();
	private static Map<String, String> params;
	public static final String url_share_photo3 = "http://activetalkgh.com/android_connect/followed_talkers.php";
	private List<Movie12> movieItems;
	ImageLoader imageLoader = AppController.getInstance().getImageLoader();

	public CustomListAdapter12(Activity activity, List<Movie12> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.list_row12, null);

		if (imageLoader == null)
			imageLoader = AppController.getInstance().getImageLoader();
		NetworkImageView thumbNail = (NetworkImageView) convertView
				.findViewById(R.id.thumbnail12);
		thumbNail.setOnClickListener(this);
		
		TextView title = (TextView) convertView.findViewById(R.id.title12);
		TextView rating = (TextView) convertView.findViewById(R.id.rating12);
		TextView genre = (TextView) convertView.findViewById(R.id.genre12);
		TextView year = (TextView) convertView.findViewById(R.id.releaseYear12);
		
	
		ImageButton follow = (ImageButton) convertView.findViewById(R.id.imageButtonfollow12);
		follow.setOnClickListener(this);
		
		

		// getting movie data for the row
		final Movie12 m = movieItems.get(position);
