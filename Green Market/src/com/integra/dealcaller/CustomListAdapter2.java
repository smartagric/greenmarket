...
public class CustomListAdapter2 extends BaseAdapter implements OnClickListener {
	...
	public CustomListAdapter2(Activity activity, List<Movie2> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final NetworkImageView thumbNail = (NetworkImageView) convertView.findViewById(R.id.vview);
		...
		ImageButton follow = (ImageButton) convertView.findViewById(R.id.imageButtonfollow2);
		follow.setOnClickListener(this);

		

		// getting movie data for the row
		final Movie2 m = movieItems.get(position);

		
		 //loads video from remote server
        //set the video path
        //vSource ="http://www.activetalkgh.com/android_connect/uploads/kitkat.3gp";
        ...
        //vView.setMediaController(new MediaController(activity));
