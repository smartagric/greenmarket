...
public class CustomListAdapter3 extends BaseAdapter implements OnClickListener {
	private Activity activity;
	private LayoutInflater inflater;
	private List<Movie3> movieItems;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = CustomListAdapter3.class.getSimpleName();
	...
	public CustomListAdapter3(Activity activity, List<Movie3> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		NetworkImageView thumbNail = (NetworkImageView) convertView
				.findViewById(R.id.vview3);
		thumbNail.setOnClickListener(this);
		
		TextView title = (TextView) convertView.findViewById(R.id.title3);
		TextView rating = (TextView) convertView.findViewById(R.id.rating3);
		TextView genre = (TextView) convertView.findViewById(R.id.genre3);
		TextView year = (TextView) convertView.findViewById(R.id.releaseYear3);
	
		ImageButton follow = (ImageButton) convertView.findViewById(R.id.imageButtonfollow3);
		...
		final Movie3 m = movieItems.get(position);
