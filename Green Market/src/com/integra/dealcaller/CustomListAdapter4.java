...
public class CustomListAdapter4 extends BaseAdapter implements OnClickListener {
	private Activity activity;
	private LayoutInflater inflater;
	private List<Movie4> movieItems;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = CustomListAdapter4.class.getSimpleName();
	...
	public CustomListAdapter4(Activity activity, List<Movie4> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView title = (TextView) convertView.findViewById(R.id.title4);
		TextView rating = (TextView) convertView.findViewById(R.id.rating4);
		TextView genre = (TextView) convertView.findViewById(R.id.genre4);
		TextView year = (TextView) convertView.findViewById(R.id.releaseYear4);
	

		//ImageButton follow = (ImageButton) convertView.findViewById(R.id.imageButtonfollow4);
		//follow.setOnClickListener(this);



		// getting movie data for the row
		final Movie4 m = movieItems.get(position);
