...
public class CustomListAdapter5 extends BaseAdapter implements OnClickListener,OnTouchListener{
	private Activity activity;
	private LayoutInflater inflater;
	private List<Movie5> movieItems;
	...
	private static final String URL_FEED2 = "http://activetalkgh.com/talkers/prayer_religion.php";
     ...
     private List<Movie5b> movieListb = new ArrayList<Movie5b>();
     private List<Movie5c> movieListc = new ArrayList<Movie5c>();
     private List<Movie5d> movieListd = new ArrayList<Movie5d>();
     static JsonObjectRequest jsonReq2;
	static JsonObjectRequest jsonReq3;
	static JsonObjectRequest jsonReq4;
     private HorizontalListView listView_b,listView_c,listView_d ;
     private CustomListAdapter5 adapter;
     private CustomListAdapter5b adapter_b;
     private CustomListAdapter5c adapter_c;
     private CustomListAdapter5d adapter_d;


	ImageLoader imageLoader = AppController.getInstance().getImageLoader();

	public CustomListAdapter5(Activity activity, List<Movie5> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (type == 1) {
		    ...
		    convertView = inflater.inflate(R.layout.horizontal_inflate2, parent, false);
		    
		  adapter_b = new CustomListAdapter5b(activity,movieListb);
			listView_b = (HorizontalListView)convertView.findViewById(R.id.listee5b);
            ...
            // making fresh volley request and getting json
               ...
               AppController.getInstance().addToRequestQueue(jsonReq2);
       		    ...
       		    convertView = inflater.inflate(R.layout.horizontal_inflate3, parent, false);
       		    
       		  adapter_c = new CustomListAdapter5c(activity,movieListc);
       			listView_c = (HorizontalListView)convertView.findViewById(R.id.listee5c);
                ...
                if (entry != null) {
                   ...
                   // making fresh volley request and getting json
                      ...
                      AppController.getInstance().addToRequestQueue(jsonReq3);
                 		    ...
                 		    convertView = inflater.inflate(R.layout.horizontal_inflate4, parent, false);
                 		    
                 		  adapter_d = new CustomListAdapter5d(activity,movieListd);
                 			listView_d = (HorizontalListView)convertView.findViewById(R.id.listee5d);
		...
		NetworkImageView thumbNail = (NetworkImageView) convertView
				.findViewById(R.id.thumbnail5);
		//thumbNail.setOnClickListener(this);
		// thumbNail.setOnClickListener(null);
		//thumbNail.setOnTouchListener(this);
		//disableTouchTheft(thumbNail);
		
		TextView title = (TextView) convertView.findViewById(R.id.title5);
		TextView rating = (TextView) convertView.findViewById(R.id.rating5);
		TextView genre = (TextView) convertView.findViewById(R.id.genre5);
		TextView year = (TextView) convertView.findViewById(R.id.releaseYear5);
		...
		final Movie5 m = movieItems.get(position);
