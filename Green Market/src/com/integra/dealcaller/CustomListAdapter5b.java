...
public class CustomListAdapter5b extends BaseAdapter implements OnClickListener, OnTouchListener{
	private Activity activity;
	private LayoutInflater inflater;
	private List<Movie5b> movieItems;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = CustomListAdapter5b.class.getSimpleName();
	...
	public CustomListAdapter5b(Activity activity, List<Movie5b> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.list_row5b, null);
		...
		final Movie5b m = movieItems.get(position);
