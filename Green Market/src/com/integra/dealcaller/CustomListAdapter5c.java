...
public class CustomListAdapter5c extends BaseAdapter implements OnClickListener, OnTouchListener{
	private Activity activity;
	private LayoutInflater inflater;
	private List<Movie5c> movieItems;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = CustomListAdapter5c.class.getSimpleName();
	...
	public CustomListAdapter5c(Activity activity, List<Movie5c> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.list_row5c, null);
		...
		final Movie5c m = movieItems.get(position);
