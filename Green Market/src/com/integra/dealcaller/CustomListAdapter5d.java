...
public class CustomListAdapter5d extends BaseAdapter implements OnClickListener, OnTouchListener{
	private Activity activity;
	private LayoutInflater inflater;
	private List<Movie5d> movieItems;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = CustomListAdapter5d.class.getSimpleName();
	...
	public CustomListAdapter5d(Activity activity, List<Movie5d> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.list_row5d, null);
		...
		final Movie5d m = movieItems.get(position);
