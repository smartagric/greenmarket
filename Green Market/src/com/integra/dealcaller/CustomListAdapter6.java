...
public class CustomListAdapter6 extends BaseAdapter implements OnClickListener {
	private Activity activity;
	private LayoutInflater inflater;
	private List<Movie6> movieItems;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = CustomListAdapter6.class.getSimpleName();
	...
	public CustomListAdapter6(Activity activity, List<Movie6> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.list_row6, null);

		if (imageLoader == null)
			imageLoader = AppController.getInstance().getImageLoader();
		FeedImageView3 thumbNail = (FeedImageView3) convertView
				.findViewById(R.id.thumbnail6);
		thumbNail.setOnClickListener(this);
		
		TextView title = (TextView) convertView.findViewById(R.id.title6);
		TextView rating = (TextView) convertView.findViewById(R.id.rating6);
		TextView genre = (TextView) convertView.findViewById(R.id.genre6);
		TextView year = (TextView) convertView.findViewById(R.id.releaseYear6);
	
		
		ImageButton follow = (ImageButton) convertView.findViewById(R.id.imageButtonfollow6);
		...
		final Movie6 m = movieItems.get(position);
