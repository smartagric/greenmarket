...
public class CustomListAdapter7c extends BaseAdapter implements OnClickListener, OnTouchListener{
	private Activity activity;
	private LayoutInflater inflater;
	private List<Movie7c> movieItems;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = CustomListAdapter7c.class.getSimpleName();
	...
	public CustomListAdapter7c(Activity activity, List<Movie7c> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.list_row7c, null);
		...
		final Movie7c m = movieItems.get(position);
