...
public class CustomListAdapter8 extends BaseAdapter implements OnClickListener{
	private Activity activity;
	private LayoutInflater inflater;
	private List<Movie8> movieItems;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = CustomListAdapter8.class.getSimpleName();
	...
	public CustomListAdapter8(Activity activity, List<Movie8> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.list_row8, null);

		if (imageLoader == null)
			imageLoader = AppController.getInstance().getImageLoader();
		NetworkImageView thumbNail = (NetworkImageView) convertView
				.findViewById(R.id.thumbnail8);
		thumbNail.setOnClickListener(this);
		
		TextView title = (TextView) convertView.findViewById(R.id.title8);
		TextView rating = (TextView) convertView.findViewById(R.id.rating8);
		TextView genre = (TextView) convertView.findViewById(R.id.genre8);
		TextView year = (TextView) convertView.findViewById(R.id.releaseYear8);
		
		
		ImageButton follow = (ImageButton) convertView.findViewById(R.id.imageButtonfollow8);
		...
		final Movie8 m = movieItems.get(position);
