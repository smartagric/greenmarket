...
public class FeedImageView2 extends ImageView {
	...
	public FeedImageView2(Context context) {
		this(context, null);
	}

	public FeedImageView2(Context context, AttributeSet attrs) {
	...
	private void loadImageIfNecessary(final boolean isInLayoutPass) {
		...
		// Load the new image
		// from the network.
		ImageContainer newContainer = mImageLoader.get(context,mUrl,
				new ImageListener() {
