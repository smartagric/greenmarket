...
public class FeedListAdapter4 extends BaseAdapter implements OnClickListener {	
	private Activity activity;
	private LayoutInflater inflater;
	private List<FeedItem4> feedItems;
	ImageLoader imageLoader = AppController.getInstance().getImageLoader();

	public FeedListAdapter4(Activity activity, List<FeedItem4> feedItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Button shop = (Button)convertView.findViewById(R.id.shop_now);
		...
		final FeedItem4 item = feedItems.get(position);
	...
	//	timestamp.setText(timeAgo);
			...
			//statusMsg.setText(item.getStatus());
						...
						if (!TextUtils.isEmpty(item.getProfilePic5())) {
							profilePic5.setImageUrl(item.getProfilePic5(), imageLoader);
			...
			shop.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
		        	...
		        	i.putExtra("foto", item.getProfilePic());
		        	i.putExtra("foto_name", item.getProfilePic_name());
		        	i.putExtra("foto_des", item.getProfilePic_description());
		        	
		        	i.putExtra("foto2", item.getProfilePic2());
		        	i.putExtra("foto2_name", item.getProfilePic2_name());
		        	i.putExtra("foto2_des", item.getProfilePic2_description());
		        	
		        	i.putExtra("foto3", item.getProfilePic3());
		        	i.putExtra("foto3_name", item.getProfilePic3_name());
		        	i.putExtra("foto3_des", item.getProfilePic3_description());
		        	
		        	i.putExtra("foto4", item.getProfilePic4());
		        	i.putExtra("foto4_name", item.getProfilePic4_name());
		        	i.putExtra("foto4_des", item.getProfilePic4_description());
		        	
		        	i.putExtra("foto5", item.getProfilePic5());
		        	i.putExtra("foto5_name", item.getProfilePic5_name());
		        	i.putExtra("foto5_des", item.getProfilePic5_description());
