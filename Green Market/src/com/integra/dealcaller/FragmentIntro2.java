...
public class FragmentIntro2 extends Fragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
  	...
  	cost = (TextView)view.findViewById(R.id.lblExpenseCancel);
  	 ...
  	 if (ShopListActivity.foto2.matches("")){
  		pb.setVisibility(View.GONE);
  	 }else{
  		cost.setText("GH¢ "+ShopListActivity.foto2_name +".00");
  		 des.setText(ShopListActivity.foto2_des);
  		 imgview.setImageUrl(ShopListActivity.foto2, imageLoader);
  		 pb.setVisibility(View.GONE);
  	 }
