...
public class FragmentIntro4 extends Fragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
  	...
  	cost = (TextView)view.findViewById(R.id.lblExpenseCancel);
  	 ...
  	 if (ShopListActivity.foto4.matches("")){
  		pb.setVisibility(View.GONE);
  	 }else{
  		 cost.setText("GH¢ "+ShopListActivity.foto4_name+".00");
  		 des.setText(ShopListActivity.foto4_des);
  		 imgview.setImageUrl(ShopListActivity.foto4, imageLoader);
  		 pb.setVisibility(View.GONE);
  	 }
