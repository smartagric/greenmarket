...
public class FragmentIntro5 extends Fragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
  	...
  	cost = (TextView)view.findViewById(R.id.lblExpenseCancel);
  	 ...
  	 if (ShopListActivity.foto5.matches("")){
  		pb.setVisibility(View.GONE);
  	 }else{
  		 cost.setText("GH¢ "+ShopListActivity.foto5_name+".00");
  		 des.setText(ShopListActivity.foto5_des);
  		 imgview.setImageUrl(ShopListActivity.foto5, imageLoader);
  		 pb.setVisibility(View.GONE);
  	 }
