...
public class FriendsListAdapter extends BaseAdapter implements OnClickListener {	
	...
	private List<FriendsItem> feedItems;
	ImageLoader imageLoader = AppController.getInstance().getImageLoader();

	public FriendsListAdapter(Activity activity, List<FriendsItem> feedItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.friends_profile_layout, null);
		...
		final FriendsItem item = feedItems.get(position);
