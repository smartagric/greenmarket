...
public class HorizontalFeedListAdapter extends BaseAdapter implements OnClickListener{	
	private Activity activity;
	private LayoutInflater inflater;
	public static List<HorizontalFeedItem> feedItemx;
	private static String postType;
	private SharedPreferences prefs;
	private static Map<String, String> params2;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = HorizontalFeedListAdapter.class.getSimpleName();
	public static final String url_share_photo3 = "http://activetalkgh.com/android_connect/shared_help_post.php";
	
	ImageLoader imageLoader = AppController.getInstance().getImageLoader();

	public HorizontalFeedListAdapter() {
		
	}
	
	
	public HorizontalFeedListAdapter(Activity activity, List<HorizontalFeedItem> feedItemx) {
		this.activity = activity;
		this.feedItemx = feedItemx;
	}


	public int getCount() {
		return feedItemx.size();
	}

	
	public Object getItem(int location) {
		return feedItemx.get(location);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.horizontal_feed_item, null);
		...
		final HorizontalFeedItem item = feedItemx.get(position);
