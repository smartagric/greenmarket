...
public class ImageCacheManager{
	...
	public void init(Context context, String uniqueName, int cacheSize, CompressFormat compressFormat, int quality, CacheType type){
		switch (type) {
		case DISK:
			mImageCache= (ImageCache) new LruBitmapCache(context, uniqueName, cacheSize, compressFormat, quality);
			break;
		case MEMORY:
	 ...
	 */
	public void getImage(Context context,String url, ImageListener listener){
		mImageLoader.get(context,url, listener);
	}
