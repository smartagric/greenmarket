...
public class ImageLoader {
     ...
     */
    public ImageContainer get(Context context, String requestUrl, final ImageListener listener) {
        return get(context, requestUrl, listener, 0, 0);
    }
    
    public ImageContainer get(Context context, String requestUrl, ImageListener imageListener,
            int maxWidth, int maxHeight) {
        return get(context, requestUrl, imageListener, null, maxWidth, maxHeight);
    }
...
//      LogUtils.d("ning1", "onGetImageSuccessc cacheKey=" + cacheKey);
    ...
    private void batchResponse(String cacheKey, BatchedImageRequest request) {
        ...
        if (mRunnable == null) {
            mRunnable = new Runnable() {
                @Override
                public void run() {
//                  LogUtils.d("ning1", "batchResponse mBatchedResponses.size():" + mBatchedResponses.size());
                    for (BatchedImageRequest bir : mBatchedResponses.values()) {
//                      LogUtils.d("ning1", "batchResponse bir.mContainers.size():" + bir.mContainers.size());
...
//                                LogUtils.d("ning1", "batchResponse container.mRequestUrl=" + container.mRequestUrl);
