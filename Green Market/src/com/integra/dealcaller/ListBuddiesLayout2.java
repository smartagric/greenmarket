...
import com.integra.dealcaller.CircularLoopAdapter;
import com.integra.dealcaller.ListBuddiesAutoScrollHelper;
 ...
 */
public class ListBuddiesLayout2 extends LinearLayout implements View.OnTouchListener, ObservableListView.ListViewObserverDelegate {

    private static final String TAG = ListBuddiesLayout2.class.getSimpleName();
    ...
    private int mGap, mGap2;
    private int mGapColor;
    private int mGapViewColor;
    ...
    public ListBuddiesLayout2(Context context) {
        super(context);
        init(context);
    }

    public ListBuddiesLayout2(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void setListBuddiesAttributes(Context context, AttributeSet attrs) {
        ...
        mGap2 = a.getDimensionPixelSize(R.styleable.ListBuddiesOptions_gap2, getResources().getDimensionPixelSize(R.dimen.default_margin_between_lists));
        ...
        mGapViewColor = a.getColor(R.styleable.ListBuddiesOptions_gapColor2, ATTR_NOT_SET);
        a.recycle();
    }

    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.love, this, true);
        mListViewLeft = (ObservableListView) findViewById(R.id.list_left2);
        mListViewRight = (ObservableListView) findViewById(R.id.list_right2);
    ...
    public ListBuddiesLayout2 setGap(int value) {
        mGap = value;
        setGap();
        return this;
    }

    public ListBuddiesLayout2 setSpeed(int value) {
        mSpeed = value;
        calibrateSpeed();
        return this;
    }

    public ListBuddiesLayout2 setDividerHeight(int value) {
        mDividerHeight = value;
        setDividerAndHeight(mDivider, value);
        return this;
    }

    public ListBuddiesLayout2 setDivider(Drawable drawable) {
        mDivider = drawable;
    ...
    public ListBuddiesLayout2 setGapColor(int color) {
        mGapColor = color;
        setGap();
        return this;
    }

    public ListBuddiesLayout2 setAutoScrollFaster(int option) {
        isAutoScrollLeftListFaster = option == 1;
        calibrateSpeed();
        return this;
    }

    public ListBuddiesLayout2 setManualScrollFaster(int option) {
        isManualScrollLeftListFaster = option == 1;
        return this;
    }

    public void setAdapters(CustomListAdapter6 adapter, CustomListAdapter6 adapter2) {
