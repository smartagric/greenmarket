...
public class MainInflateAdapter extends BaseAdapter implements OnClickListener{	
	private Activity activity;
	private LayoutInflater inflater;
	private List<Movie_main> feedItems;
	private static String postType;
	private SharedPreferences prefs;
	private static Map<String, String> params2;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = MainInflateAdapter.class.getSimpleName();
	public static final String url_share_photo3 = "http://activetalkgh.com/android_connect/shared_help_post.php";
	
	ImageLoader imageLoader = AppController.getInstance().getImageLoader();

	public MainInflateAdapter(Activity activity, List<Movie_main> feedItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.inflator1, null);
		...
		final Movie_main item = feedItems.get(position);
