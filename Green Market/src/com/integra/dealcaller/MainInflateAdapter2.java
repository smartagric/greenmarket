...
public class MainInflateAdapter2 extends BaseAdapter implements OnClickListener{	
	private Activity activity;
	private LayoutInflater inflater;
	private List<Movie_main2> feedItems;
	private static String postType;
	private SharedPreferences prefs;
	private static Map<String, String> params2;
	private static final String TAG_SUCCESS = "success";
	private static final String TAG = MainInflateAdapter2.class.getSimpleName();
	public static final String url_share_photo3 = "http://activetalkgh.com/android_connect/shared_help_post.php";
	
	ImageLoader imageLoader = AppController.getInstance().getImageLoader();

	public MainInflateAdapter2(Activity activity, List<Movie_main2> feedItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.inflator2, null);
		...
		final Movie_main2 item = feedItems.get(position);
