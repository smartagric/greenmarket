...
public class NetworkImageView2 extends ImageView {
    ...
    public NetworkImageView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NetworkImageView2(Context context, AttributeSet attrs, int defStyle) {
     ...
     * {@link NetworkImageView2#setDefaultImageResId(int)} on the view.
     *
     * NOTE: If applicable, {@link NetworkImageView2#setDefaultImageResId(int)} and
     * {@link NetworkImageView2#setErrorImageResId(int)} should be called prior to calling
     * this function.
     *
