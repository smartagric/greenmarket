 ...
 * associated request.
 */
public class NetworkImageView5 extends ImageView {
    ...
    public NetworkImageView5(Context context) {
        this(context, null);
    }

    public NetworkImageView5(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NetworkImageView5(Context context, AttributeSet attrs, int defStyle) {
     ...
     * {@link NetworkImageView5#setDefaultImageResId(int)} on the view.
     *
     * NOTE: If applicable, {@link NetworkImageView5#setDefaultImageResId(int)} and
     * {@link NetworkImageView5#setErrorImageResId(int)} should be called prior to calling
     * this function.
     *
