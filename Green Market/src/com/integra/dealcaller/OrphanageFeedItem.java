...
public class OrphanageFeedItem {
	/**
	 * 
	 */
	...
	public OrphanageFeedItem() {
	}

	public OrphanageFeedItem(int id,int expression,int comments, String name, String image, String status,
