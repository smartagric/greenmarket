...
import com.integra.dealcaller.FlipLoadingLayout;
import com.integra.dealcaller.LoadingLayout;
import com.integra.dealcaller.R;
import com.integra.dealcaller.RotateLoadingLayout;
import com.integra.dealcaller.Utills;
import com.integra.dealcaller.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
			...
			Utills.warnDeprecation("ptrAdapterViewBackground", "ptrRefreshableViewBackground");
