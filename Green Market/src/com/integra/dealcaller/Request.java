...
import com.integra.dealcaller.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    public Request(int method, String url, Response.ErrorListener listener, LoadingListener loadingListener) {
        mMethod = method;
        mUrl = url;
    ...
    public void deliverLoading(long count, long current) {
        if (mLoadingListener != null) {
            mLoadingListener.onLoading(count, current);
        }
    }
    ...
    public String toString() {
        ...
        return (mCanceled ? "[X] " : "[ ] ") + getUrl() + " " + trafficStatsTag + " "
                + getPriority() + " " + mSequence + mLoadingListener;
    }
