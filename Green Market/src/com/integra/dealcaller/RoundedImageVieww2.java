...
public class RoundedImageVieww2 extends ImageView {
  ...
  public RoundedImageVieww2(Context context) {
    super(context);
  }

  public RoundedImageVieww2(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public RoundedImageVieww2(Context context, AttributeSet attrs, int defStyle) {
