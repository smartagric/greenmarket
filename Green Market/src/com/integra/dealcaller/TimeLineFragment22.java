...
public class TimeLineFragment22 extends Fragment implements OnClickListener,OnTouchListener{
	
	
	 
    // Movies json url
	private static final String TAG = TimeLineFragment22.class.getSimpleName();
    ...
    ViewGroup container, Bundle savedInstanceState)
    {
     ...
     animSlideDown = AnimationUtils.loadAnimation(getActivity(),R.anim.fade_out);
       ...
       // listView.setStackFromBottom(true);
        ...
        listAdapter = new FeedListAdapter22(getActivity(), feedItems);
