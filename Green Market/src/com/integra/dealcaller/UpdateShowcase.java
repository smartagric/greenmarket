...
public class UpdateShowcase extends ActionBarActivity implements OnClickListener {

	private List<UpdateShowcaseItem> feedItems;
	private UpdateShowcaseListAdapter listAdapter;
	...
	setContentView(R.layout.commitment_page_detail2);

	
	
	feedItems = new ArrayList<UpdateShowcaseItem>();
    
	 
    listAdapter = new UpdateShowcaseListAdapter(this, feedItems);
...
private void parseJsonFeed(JSONObject response) {
    try {
        ...
        for (int i = 0; i < feedArray.length(); i++) {
            ...
            UpdateShowcaseItem item = new UpdateShowcaseItem();
            ...
            String nest = feedObj.isNull("nesting_institution") ? null : feedObj.getString("nesting_institution");
            item.setNesting(nest);
            
            String veri = feedObj.isNull("verification_status") ? null : feedObj.getString("verification_status");
            item.setVerify(veri);
         ...
         // Pic5 might be null sometimes
            ...
            String url = feedObj.isNull("url") ? null : feedObj
                    .getString("url");
